...
This is a regression problem as I would like to predict a numerical outcome: `likes`, the like count of a comment. The predictors will be the emotional categories from LIWC, which are all numerical. I also created a categorical variable called "comment_length" that categories a comment based on its length being short, medium, or long.
