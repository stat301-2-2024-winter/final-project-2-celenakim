...
tbl_result_accuracy
```
@fig-model-results contains a table of the best performing model results, in terms of accuracy. The random forest model a (with the kitchen sink recipe) obtained the highest accuracy of 0.949, while the null model, elastic net model a, and elastic net model b model all obtained the lowest accuracy of 0.513.
...
select_best(tuned_en_a, metric = "accuracy") |> 
  knitr::kable()
```
As seen in @fig-autoplot-tuned-en-a and @fig-selectbest-tuned-en-a, the best parameters to obtain the highest accuracy for the elastic net model a is a penalty of 0 and a mixture of 0.7625.
...
select_best(tuned_en_b, metric = "accuracy") |> 
  knitr::kable()
```
@fig-autoplot-tuned-en-b and @fig-selectbest-tuned-en-b show that the best parameters to obtain the highest accuracy for the elastic net model b are also a penalty of 0 and a mixture of 0.7625.
...
select_best(tuned_knn_a, metric = "accuracy") |> 
  knitr::kable()
```
@fig-autoplot-tuned-knn-a and @fig-selectbest-tuned-knn-a show that the best parameter to obtain the highest accuracy for the k nearest neighbors model a is 1 neighbor.
...
select_best(tuned_knn_b, metric = "accuracy") |> 
  knitr::kable()
```
As seen in @fig-autoplot-tuned-knn-b and @fig-selectbest-tuned-knn-b, the best parameter to obtain the highest accuracy for the k nearest neighbors model b is 34 neighbors.
